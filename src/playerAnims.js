...
It exports all of the animations into a variable called anims. Import
this file into the Player class and you can use the variable, anims, as
if it was written in that class.
*/
